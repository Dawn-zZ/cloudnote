...
<form class="layui-form" style="width: 80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="username" class="layui-input"
                   lay-verify="required" readonly="readonly" name="username" value="${user.username }">
        </div>
    </div>
    <input type="hidden" name="image" class="image" value="${user.image}">
    <div class="layui-form-item">
        ...
        <div class="layui-upload">
            ...
            <div class="layui-upload-list">
                ...
                <img class="layui-upload-img" id="demo1" src="${user.image}" width="80px"
                     height="80px">
            </div>
            <label class="layui-form-label"></label>
            <p id="demoText"></p>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="nickname" class="layui-input"
                   lay-verify="required" placeholder="请输入昵称" value="${user.nickname }">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="note" class="layui-textarea" placeholder="请输入个人签名">${user.note }</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
