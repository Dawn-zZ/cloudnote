...
<form class="layui-form" style="width: 80%;" id="aaf">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="username" class="layui-input userName"
                   lay-verify="required" placeholder="请输入用户名" name="username" autocomplete="off" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="code" id="code" lay-verify="required" lay-reqtext="验证码不能为空" placeholder="请输入邮箱验证码" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
