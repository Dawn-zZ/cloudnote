...
layui.use(['form', 'layedit', 'laypage'], function () {
    ...
    var noteId = $('#id').text();
    var url = ctx + "/getRemark";
    var config = {page: 1, limit: 10, noteId: noteId};//page:起始页;limit:页面容量;
...
function parseNoteList(res, currPage) {
    ...
    var url2 = ctx + "/getReply";
    var config2 = {noteId: noteId};

    $.getJSON(url2, config2, function (res2) {
